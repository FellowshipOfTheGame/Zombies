...
public class HUDScript : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Events.OnRemainingEnemiesUpdate += UpdateEnemiesCounter;
        Events.OnWaveFinish += IncreaseWaveCounter;
    ...
    private void IncreaseWaveCounter(int wave)
    {
        ...
        StartCoroutine(WaveCounterVisualsI());
    }
    private IEnumerator WaveCounterVisualsI()
    {
    ...
    private void WaveStart() { StartCoroutine(WaveCounterVisualsII()); }
    private IEnumerator WaveCounterVisualsII()
    {
        for (float i = 0; i <= 50; i++)
        {   // lightGray --> red
            float index = i / 50f;
