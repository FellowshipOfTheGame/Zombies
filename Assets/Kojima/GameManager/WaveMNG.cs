...
public class WaveMNG : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        enemySpawner.SpawnEnemies(maxEnemies, weight);
    }
    ...
    {
        ++waveCount;
        EventsMNG.IncreaseWaveCounter(waveCount);  // atualiza o valor e troca a cor dos counters de vinho pra cinza
        yield return new WaitForSeconds(4);
        EventsMNG.StartWave();  // troca a cor de cinza pra vinho
        yield return new WaitForSeconds(1);
